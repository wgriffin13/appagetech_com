...
class Water extends Component {
    ...
    sceneSetup = () => {
        ...
        camera = new THREE.PerspectiveCamera( 40, window.innerWidth / window.innerHeight, .25, 3000 );
        ...
        gui.add( effectController, "mouseSize", 1.0, 100.0, 1.0 ).onChange( this.valuesChanger );
        gui.add( effectController, "viscosity", 0.9, 0.999, 0.001 ).onChange( this.valuesChanger );
        gui.add( effectController, "spheresEnabled", 0, 1, 1 ).onChange( this.valuesChanger );
        var buttonSmooth = {
