...
function Transition(sceneA, sceneB) {
  ...
  for (var i = 0; i < 6; i++) this.textures[i] = loader.load("textures/transition/transition" + (i + 1) + ".png");
...
class TransitionExample extends Component {
  componentDidMount() {
    console.log(createTransitionSinWaveArray(0.02, transitionParams.transitionSpeed));
    this.init();
    this.animate();
  }
